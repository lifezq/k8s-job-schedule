...
/**
 * @Package com.lifezq.schedule.config
 * @ClassName ThreadPoolTaskConfigure
 * @Description TODO
 * @Author ryan
 * @Date 2022/1/1
 */
 ...
 *
 * @Async 标注的方法上 不能同时标注 @Transactional 注解，否则失效。可以在@Transactional标注的方法内部调用异步方法
 */
@EnableAsync
@Configuration
public class ThreadPoolTaskConfigure {
    ...
    // 盘点单线程池名前缀
    private static final String countingWoThreadNamePrefix = "exchange-Async-Service-";
    ...
    public Executor taskExecutor() {
        ...
        executor.setThreadNamePrefix(countingWoThreadNamePrefix);
